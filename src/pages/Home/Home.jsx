...
import trabalho1 from "../../assets/img/pessoa.png"
import trabalho2 from "../../assets/img/pessoa.png"
import trabalho3 from "../../assets/img/pessoa.png"

import detalhe1 from "../../assets/img/pessoa.png"
import detalhe2 from "../../assets/img/pessoa.png"
import detalhe3 from "../../assets/img/pessoa.png"
                  ...
                  <div className="row g-0">
                    <div className="col-lg-8">
                      <div className="portfolio-modal-image">
                        <img
                          src="/volunteers-helping-elderly-people-in-nursing-home.jpg"
                        ...
                        <div className="portfolio-details">
                          ...
                          <div className="portfolio-gallery">
                            ...
                            <div className="row g-2">
                              <div className="col-4">
                                <img
                                  src="/volunteer-reading-to-elderly-person.jpg"
                                  alt="Voluntário lendo"
                                  className="img-fluid rounded"
                                />
                              </div>
                              <div className="col-4">
                                <img
                                  src="/volunteers-playing-games-with-elderly.jpg"
                                  alt="Jogos com idosos"
                                  className="img-fluid rounded"
                                />
                              </div>
                              <div className="col-4">
                                <img
                                  src="/volunteer-walking-with-elderly-person.jpg"
                                  alt="Passeio com idoso"
                                  className="img-fluid rounded"
                                />
                              </div>
                            </div>
                ...
                <div className="container-fluid p-0">
                  <div className="row g-0">
                    <div className="col-lg-8">
                      <div className="portfolio-modal-image">
                        <img
                          src="/elderly-people-enjoying-cultural-event-party-celeb.jpg"
                    ...
                    <div className="col-lg-4">
                      <div className="portfolio-modal-info">
                        ...
                        <p className="item-intro text-muted">Criando momentos especiais e memoráveis</p>

                        <div className="portfolio-details">
                          <h4>Tipos de Eventos</h4>
                          <ul className="portfolio-list">
                            <li>Festas temáticas e comemorações</li>
                            <li>Oficinas e workshops criativos</li>
                            <li>Atividades culturais e artísticas</li>
                            <li>Eventos musicais e apresentações</li>
                            <li>Celebrações de datas especiais</li>
                          </ul>

                          <h4>Próximos Eventos</h4>
                          <div className="evento-card">
                            <h5>Festa Junina Solidária</h5>
                            <p>
                              <strong>Data:</strong> 15/06/2024
                            </p>
                            <p>
                              <strong>Local:</strong> Asilo São Vicente
                            </p>
                          </div>
                          <div className="evento-card">
                            <h5>Oficina de Artesanato</h5>
                            <p>
                              <strong>Data:</strong> 22/06/2024
                            </p>
                            <p>
                              <strong>Local:</strong> Lar dos Idosos Esperança
                            </p>
                          </div>
                          ...
                          <div className="portfolio-gallery">
                            ...
                            <div className="row g-2">
                              <div className="col-4">
                                <img
                                  src="/elderly-people-at-party-celebration.jpg"
                                  alt="Festa"
                                  className="img-fluid rounded"
                                />
                              </div>
                              <div className="col-4">
                                <img
                                  src="/elderly-people-doing-crafts-workshop.jpg"
                                  alt="Oficina"
                                  className="img-fluid rounded"
                                />
                              </div>
                              <div className="col-4">
                                <img
                                  src="/elderly-people-enjoying-music-performance.jpg"
                                  alt="Música"
                                  className="img-fluid rounded"
                                />
                              </div>
