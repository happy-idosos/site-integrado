      ...
      <main className="termos-de-uso-page">
        ...
        <div className="termos-de-uso-container">
          <div className="termos-de-uso-header" data-aos="fade-down">
            <img src={logo || "/placeholder.svg"} alt="Happy Idosos" className="termos-de-uso-logo" />
            ...
            <div className="termos-de-uso-content">
              ...
              <article className="termos-de-uso-article">
                ...
                <section id="cadastro" className="termos-de-uso-section" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <ul>
                    <li><strong>a)</strong> Apresentem informações inconsistentes ou falsas;</li>
                    <li><strong>b)</strong> Infrinjam estes Termos ou a legislação aplicável;</li>
                    <li><strong>c)</strong> Possam comprometer a integridade ou segurança dos idosos.</li>
                  </ul>
                </section>
                ...
                <section id="obrigacoes" className="termos-de-uso-section" data-aos="fade-up" data-aos-delay="350">
                  ...
                  <ul>
                    <li><strong>a)</strong> Publicar conteúdo ilegal, ofensivo, discriminatório ou contrário à moral;</li>
                    <li><strong>b)</strong> Utilizar a Plataforma para fins comerciais não autorizados;</li>
                    <li><strong>c)</strong> Violar direitos de propriedade intelectual ou de imagem;</li>
                    <li><strong>d)</strong> Praticar qualquer forma de assédio ou divulgar informações falsas.</li>
                  </ul>
                </section>
                ...
                <section id="responsabilidade" className="termos-de-uso-section" data-aos="fade-up" data-aos-delay="500">
                  ...
                  <ul>
                    <li><strong>a)</strong> Danos decorrentes de atividades realizadas fora do ambiente virtual;</li>
                    <li><strong>b)</strong> Condutas inadequadas de usuários ou terceiros;</li>
                    <li><strong>c)</strong> Conteúdos publicados por instituições ou voluntários.</li>
                  </ul>
